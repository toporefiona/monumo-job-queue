...
Opening up a powerful internal engine, like Monumo's Anser, to external customers is a hard infrastructure problem, queuing, scheduling, retrying and isolating jobs safely, so the system stays reliable even when things fail. This project is my own attempt to understand and demonstrate that problem directly.

## What it does

This is a FastAPI application that accepts jobs, processes them in the background, and handles failure realistically.
...
This is a small, honest demonstration, not a production system. It does not yet include things like authentication, a proper database, or handling genuinely concurrent load at scale. It was built to show real understanding of the problem.